...
export default function ExCashTopup() {
  ...
  const packages = [
    { id: 1, price: 50, amount: "บัตร EX CASH 50 บาท" },
    { id: 2, price: 90, amount: "บัตร EX CASH 90 บาท" },
    { id: 3, price: 150, amount: "บัตร EX CASH 150 บาท" },
    { id: 4, price: 300, amount: "บัตร EX CASH 300 บาท" },
    { id: 5, price: 500, amount: "บัตร EX CASH 500 บาท" },
    { id: 6, price: 1000, amount: "บัตร EX CASH 1000 บาท" },
  ];
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-xs font-bold flex items-center gap-1.5">
                <Gamepad2 size={14} /> ใช้ได้ทุกเกมในเครือ EX
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="text-gray-900 font-bold">Ex Cash Card</span>
                </div>
                <div className="flex justify-between items-center text-sm">
