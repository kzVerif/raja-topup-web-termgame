...
export default function ExCashTopup() {
  ...
  const packages = [
    { id: 1, price: 139, amount: "บัตร Riot Prepaid Card 50 บาท" },
    { id: 2, price: 279, amount: "บัตร Riot Prepaid Card 100 บาท" },
    { id: 3, price: 559, amount: "บัตร Riot Prepaid Card 300 บาท" },
    { id: 4, price: 979, amount: "บัตร Riot Prepaid Card 500 บาท" },
    { id: 5, price: 1400, amount: "บัตร Riot Prepaid Card 1000 บาท" },
    { id: 6, price: 2800, amount: "บัตร Riot Prepaid Card 3500 บาท" },
  ];
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-red-100 text-red-700 rounded-full text-xs font-bold flex items-center gap-1.5">
                <Gamepad2 size={14} /> ใช้ได้กับ Riot Account TH
              </span>
            </div>
          </div>
        </div>
