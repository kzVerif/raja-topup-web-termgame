...
export default function ExCashTopup() {
  ...
  const packages = [
    { id: 1, price: 399, amount: "Performance Package 399 บาท" },
    { id: 2, price: 649, amount: "Ultimate Package 649 บาท" },
  ];
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            <h1 className="text-3xl md:text-4xl font-black text-gray-900">
              ซื้อบัตร Geforce Now (ประเทศไทย)
            </h1>
            ...
            <p className="text-red-500 max-w-xl leading-relaxed">
              เปิดใช้งานรหัสที่ www.bro.game/true-gateway
            </p>
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold flex items-center gap-1.5">
                <Gamepad2 size={14} /> เล่นเกม PC บนมือถือ
              </span>
            </div>
          </div>
        </div>
