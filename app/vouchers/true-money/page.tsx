...
export default function page() {
  ...
  const packages = [
    { id: 1, price: 50, amount: "บัตรเงินสดทรูมันนี่ 50 บาท" },
    { id: 2, price: 90, amount: "บัตรเงินสดทรูมันนี่ 90 บาท" },
    { id: 3, price: 150, amount: "บัตรเงินสดทรูมันนี่ 150 บาท" },
    { id: 4, price: 300, amount: "บัตรเงินสดทรูมันนี่ 300 บาท" },
    { id: 5, price: 500, amount: "บัตรเงินสดทรูมันนี่ 500 บาท" },
    { id: 6, price: 1000, amount: "บัตรเงินสดทรูมันนี่ 1000 บาท" },
  ];
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-orange-100 text-orange-700 rounded-full text-xs font-bold flex items-center gap-1.5">
                <CreditCard size={14} /> เติมเกม/จ่ายบิล/เติมวอลเล็ท
              </span>
            </div>
          </div>
        </div>
