...
export default function ExCashTopup() {
  ...
  const packages = [
    { id: 1, price: 50, amount: "บัตร Razer Gold 50 บาท" },
    { id: 2, price: 100, amount: "บัตร Razer Gold 100 บาท" },
    { id: 3, price: 300, amount: "บัตร Razer Gold 300 บาท" },
    { id: 4, price: 500, amount: "บัตร Razer Gold 500 บาท" },
    { id: 5, price: 1000, amount: "บัตร Razer Gold 1000 บาท" },
    { id: 6, price: 3500, amount: "บัตร Razer Gold 3500 บาท" },
    { id: 7, price: 5000, amount: "บัตร Razer Gold 5000 บาท" },
  ];
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-gray-50 text-gray-600 rounded-full text-xs font-bold flex items-center gap-1.5">
                <ShoppingBag size={14} /> เติมได้กว่า 33,000 เกม
              </span>
            </div>
          </div>
        </div>
