...
interface RovPackage {
  id: number;
  price: number;
  amount: string;
}

export default function RovTopup() {
  const [selectedPackage, setSelectedPackage] = useState<RovPackage>();
  const [userId, setUserId] = useState("");

  // แปลงข้อมูลจาก JSON
  const packages: RovPackage[] = [
    { id: 1, price: 10, amount: "11 คูปอง" },
    { id: 2, price: 20, amount: "24 คูปอง" },
    { id: 3, price: 50, amount: "60 คูปอง" },
    { id: 4, price: 90, amount: "110 คูปอง" },
    { id: 5, price: 150, amount: "185 คูปอง" },
    { id: 6, price: 300, amount: "370 คูปอง" },
    { id: 7, price: 500, amount: "620 คูปอง" },
    { id: 8, price: 1000, amount: "1,240 คูปอง" },
  ];
      ...
      <div className="container max-w-6xl">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="relative w-32 h-32 md:w-40 md:h-40 shrink-0 overflow-hidden rounded-[2rem] shadow-lg">
            <Image
              src="/topup/rov.png" // ใช้ไฟล์ rov.png
              alt="RoV Mobile"
              fill
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            {/* คำบรรยายสไตล์ราชา (แต่ UI ปกติ) */}
            <p className="text-gray-500 max-w-xl leading-relaxed">
              สมรภูมิ Realm of Valor กำลังลุกเป็นไฟ! อย่าปล่อยให้สกินระดับ Ultimate 
              หลุดมือไปเพียงเพราะคูปองไม่พอ... จงเติมพลังแห่งศรัทธา เพื่อคว้า MVP และทะยานสู่แรงค์ Conqueror! 
              ศัตรูจะต้องสยบแทบเท้าเมื่อเห็นกรอบโหลดสกินทองคำของเจ้า... จงประกาศศักดาให้ลือลั่นทั่วทั้งเซิร์ฟเวอร์!
            </p>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-xs font-bold flex items-center gap-1.5">
                <Gamepad2 size={14} /> คูปองเข้าทันที
              </span>
            </div>
          </div>
        </div>
            ...
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <User size={20} className="text-indigo-600" /> กรอก OpenID
                </h2>
              </div>
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="กรอก OpenID ของคุณ (ตัวเลข)"
                  value={userId}
                ...
                <p className="text-sm text-gray-400 font-medium italic">
                  * ดู OpenID ได้ที่เมนูตั้งค่า (รูปฟันเฟือง) {">"} ทั่วไป {">"} กดปุ่ม 'เปิด ID'
                </p>
              </div>
            </section>
            ...
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <p className="text-[10px] text-center text-gray-400 leading-relaxed">
                  ...
                  <br />
                  กรุณาตรวจสอบ OpenID ให้ถูกต้องก่อนชำระเงิน
                </p>
              </div>
            </div>
          </div>
