...
export default function PubgMobileTopup() {
  const [selectedPackage, setSelectedPackage] = useState<PubgmPackage>();
  const [userId, setUserId] = useState("");

  // แปลงข้อมูลจาก JSON
  const packages: PubgmPackage[] = [
    { id: 1, price: 33, amount: "60 UC" },
    { id: 2, price: 165, amount: "325 UC" },
    { id: 3, price: 330, amount: "660 UC" },
    { id: 4, price: 825, amount: "1,800 UC" },
    { id: 5, price: 1650, amount: "3,850 UC" },
    { id: 6, price: 3300, amount: "8,100 UC" },
  ];
      ...
      <div className="container max-w-6xl">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="relative w-32 h-32 md:w-40 md:h-40 shrink-0 overflow-hidden rounded-[2rem] shadow-lg">
            <Image
              src="/topup/pubgm.webp" // ใช้ไฟล์ pubgm.webp ตาม Memory
              alt="PUBG Mobile"
              fill
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            {/* ส่วนคำบรรยาย: จัดเต็มความมันส์ตามสั่ง */}
            <p className="text-gray-500 max-w-xl leading-relaxed">
              โดดร่มลงสู่สมรภูมิเดือด Erangel! อย่าปล่อยให้กระสุนหมดกลางวงบีบ... 
              รีบเติม UC เพื่ออัปเกรดปืน, สุ่ม X-Suit ระดับตำนาน และเหมา Royal Pass ซีซั่นล่าสุด! 
              เตรียมอาวุธให้พร้อม ลั่นไกสังหาร แล้วไปกินไก่ฉลองชัยชนะ Winner Winner Chicken Dinner!
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* STEP 1: PLAYER ID (Standard UI Label) */}
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <User size={20} className="text-indigo-600" /> กรอก Player ID
                </h2>
              </div>
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="กรอก Player ID ของคุณ (ตัวเลข)"
                  value={userId}
                ...
                <p className="text-sm text-gray-400 font-medium italic">
                  * สามารถดู Player ID ได้ที่หน้าโปรไฟล์มุมซ้ายบนของเกม
                </p>
              </div>
            </section>

            {/* STEP 2: PACKAGES (Standard UI Label) */}
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-indigo-600 text-white rounded-xl flex items-center justify-center font-bold">
                  2
            ...
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <p className="text-[10px] text-center text-gray-400 leading-relaxed">
                  ...
                  <br />
                  กรุณาตรวจสอบ Player ID ให้ถูกต้องก่อนชำระเงิน
                </p>
              </div>
            </div>
          </div>
