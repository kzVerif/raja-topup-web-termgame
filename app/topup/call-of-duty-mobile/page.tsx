...
export default function TopupDetail() {
  const [selectedPackage, setSelectedPackage] = useState<codPackage>();
  const [openId, setOpenId] = useState("");

  const packages = [
    { id: 1, price: 20, amount: "48 CP"},
    { id: 2, price: 50, amount: "126 CP"},
    { id: 3, price: 90, amount: "227 CP"},
    { id: 4, price: 100, amount: "252 CP"},
    { id: 5, price: 150, amount: "378 CP"},
    { id: 6, price: 300, amount: "792 CP"},
    { id: 7, price: 500, amount: "1,440 CP"},
    { id: 8, price: 1000, amount: "3,000 CP"},
  ];
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-gray-500 max-w-xl leading-relaxed">
              เติม COD Points (CP) ง่ายๆ เพียงกรอก Open ID
              แล้วเตรียมตัวเป็นราชาแห่งสนามรบได้เลย บริการไว มั่นใจได้ 100%
            </p>
            ...
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <User size={20} className="text-indigo-600" /> กรอก Open ID
                </h2>
              </div>
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="กรอก Open ID ของคุณ (เช่น 1234567890)"
                  value={openId}
