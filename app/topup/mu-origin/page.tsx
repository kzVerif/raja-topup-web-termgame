...
interface MuPackages {
  id: number;
  price: number;
  amount: string;
}

export default function MuOrigin3Topup() {
  const [selectedPackage, setSelectedPackage] = useState<MuPackages>();
  const [userId, setUserId] = useState("");

  // แปลงข้อมูลจาก JSON "denomination"
  const packages: MuPackages[] = [
    { id: 1, price: 179, amount: "350 เพชรศักดิ์สิทธิ์" },
    { id: 2, price: 549, amount: "1,050 เพชรศักดิ์สิทธิ์" },
    { id: 3, price: 1100, amount: "2,100 เพชรศักดิ์สิทธิ์" },
    { id: 4, price: 1800, amount: "3,500 เพชรศักดิ์สิทธิ์" },
    { id: 5, price: 3700, amount: "7,000 เพชรศักดิ์สิทธิ์" },
    { id: 6, price: 5500, amount: "10,500 เพชรศักดิ์สิทธิ์" },
    { id: 7, price: 7200, amount: "14,000 เพชรศักดิ์สิทธิ์" },
    { id: 8, price: 10900, amount: "21,000 เพชรศักดิ์สิทธิ์" },
  ];
      ...
      <div className="container max-w-6xl">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="relative w-32 h-32 md:w-40 md:h-40 shrink-0 overflow-hidden rounded-[2rem] shadow-lg">
            <Image
              src="/topup/mu.png" // ใช้ไฟล์ mu.png
              alt="MU Origin 3"
              fill
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            {/* ส่วนนี้ยังคงความเบียวไว้ตามคำสั่ง */}
            <p className="text-gray-500 max-w-xl leading-relaxed">
              เหล่าผู้กล้าแห่งทวีป MU เอ๋ย! ถึงเวลาแล้วที่เจ้าจะกางปีกอันเจิดจรัสให้สะท้านฟ้าสะเทือนดิน! 
              จงรับพลังจาก 'เพชรศักดิ์สิทธิ์' เพื่อตีบวกศาสตราเทพให้ถึง +15 ส่องประกายข่มขวัญปีศาจ Kundun 
              อย่าให้ความมืดมิดกลืนกินศรัทธา... จงเติมพลังเดี๋ยวนี้ แล้วก้าวขึ้นเป็นราชันย์สงครามผู้ครอบครองพลังระดับตำนาน!
            </p>
            
            {/* Badges บังคับตาม Pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* STEP 1: ROLE ID (กลับมาใช้คำมาตรฐาน) */}
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <User size={20} className="text-indigo-600" /> กรอก Role ID
                </h2>
              </div>
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="กรอก Role ID ของคุณ"
                  value={userId}
                ...
                <p className="text-sm text-gray-400 font-medium italic">
                  * ตรวจสอบ Role ID ให้ถูกต้องเพื่อความรวดเร็ว
                </p>
              </div>
            </section>

            {/* STEP 2: PACKAGES (กลับมาใช้คำมาตรฐาน) */}
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-indigo-600 text-white rounded-xl flex items-center justify-center font-bold">
                  2
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {packages.map((pkg) => (
                  ...
                  >
                    <div>
                      <p className="text-sm font-bold text-gray-500 group-hover:text-indigo-600 transition-colors uppercase leading-tight">
                        {pkg.amount}
                      </p>
                    </div>
            ...
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <p className="text-[10px] text-center text-gray-400 leading-relaxed">
                  ...
                  <br />
                  กรุณาตรวจสอบ Role ID ให้ถูกต้องก่อนชำระเงิน
                </p>
              </div>
            </div>
          </div>
