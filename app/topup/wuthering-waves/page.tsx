...
export default function GenshinTopup() {
  ...
  const packages: ffPackages[] = [
    { id: 1, price: 179, amount: "Lunite Subscription", isSpecial: true },
    { id: 2, price: 35, amount: "60 Lunites" },
    { id: 3, price: 179, amount: "330 Lunites" },
    { id: 4, price: 549, amount: "1,090 Lunites" },
    { id: 5, price: 1100, amount: "2,240 Lunites" },
    { id: 6, price: 1800, amount: "3,880 Lunites" },
    { id: 7, price: 3700, amount: "8,080 Lunites" },
  ];
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-gray-500 max-w-xl leading-relaxed">
              พวกเจ้ายังรอโชคชะตาจากเศษเสี้ยว Astrite อันน้อยนิดอยู่อีกรึ?
              ช่างน่าขัน! สำหรับข้า... โชคชะตาคือสิ่งที่ต้อง 'ซื้อ'
              มาด้วยความเด็ดเดี่ยว การก้าวข้ามขีดจำกัด S6 R5 ไม่ใช่เรื่องของดวง
              แต่มันคือ วิถีแห่งราชา จงละทิ้งความลังเล
              แล้วเปลี่ยนเสียงกระเป๋าตังค์ให้กลายเป็นเสียงคำรามที่สั่นสะเทือนไปทั้งโลก
              Wuthering Waves!
            </p>
