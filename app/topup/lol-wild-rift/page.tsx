...
interface wrPackages {
  id: number;
  price: number;
  amount: string;
}

export default function WildRiftTopup() {
  const [selectedPackage, setSelectedPackage] = useState<wrPackages>();
  const [openId, setOpenId] = useState("");

  // แปลงข้อมูลจาก JSON "denomination"
  const packages: wrPackages[] = [
    { id: 1, price: 150, amount: "425 Cores" },
    { id: 2, price: 340, amount: "1,000 Cores" },
    { id: 3, price: 600, amount: "1,850 Cores" },
    { id: 4, price: 1050, amount: "3,275 Cores" },
    { id: 5, price: 1500, amount: "4,800 Cores" },
    { id: 6, price: 3000, amount: "10,000 Cores" },
  ];
      ...
      <div className="container max-w-6xl">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="relative w-32 h-32 md:w-40 md:h-40 shrink-0 overflow-hidden rounded-[2rem] shadow-lg">
            <Image
              src="/topup/lolw.jpg" // รูป Wild Rift
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-gray-500 max-w-xl leading-relaxed">
              จงสดับรับฟังเหล่ามอร์ทัลทั้งหลาย! ยามนี้ Summoner's Rift ได้ถูกย่อส่วนลงมาอยู่ในอุ้งมือข้า 
              แต่พลังอำนาจแห่ง Wild Cores นั้นหาได้ลดทอนลงไม่! 
              ข้าจะใช้มันปลดผนึกสกินระดับตำนานที่จะแผดเผานัยน์ตาของศัตรูให้มอดไหม้ 
              นิ้วโป้งของข้าร่ายรำบนหน้าจอดั่งสายฟ้าฟาด นำมาซึ่งหายนะแก่ผู้โง่เขลาที่กล้าต่อกร! 
              จงเติมพลัง แล้วก้าวเข้าสู่สนามรบฉบับพกพาที่ข้าเป็นผู้บัญชาการแต่เพียงผู้เดียว!
            </p>
            ...
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <User size={20} className="text-indigo-600" /> กรอก Riot ID
                </h2>
              </div>
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="Riot ID (เช่น Name#Tag)"
                  value={openId}
                ...
                <p className="text-sm text-gray-400 font-medium italic">
                  * กรุณากรอก Riot ID ให้ถูกต้องเพื่อความรวดเร็วประดุจสายลม
                </p>
              </div>
            </section>
            ...
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <p className="text-[10px] text-center text-gray-400 leading-relaxed">
                  ...
                  <br />
                  กรุณาตรวจสอบ Riot ID ให้ถูกต้องก่อนชำระเงิน
                </p>
              </div>
            </div>
          </div>
