...
interface lolPackages {
  id: number;
  price: number;
  amount: string;
}

export default function LeagueOfLegendsTopup() {
  const [selectedPackage, setSelectedPackage] = useState<lolPackages>();
  const [openId, setOpenId] = useState("");

  // แปลงข้อมูลจาก JSON "denomination"
  const packages: lolPackages[] = [
    { id: 1, price: 130, amount: "575 RP" },
    { id: 2, price: 290, amount: "1,380 RP" },
    { id: 3, price: 560, amount: "2,800 RP" },
    { id: 4, price: 890, amount: "4,500 RP" },
    { id: 5, price: 1250, amount: "6,500 RP" },
    { id: 6, price: 2550, amount: "13,500 RP" },
  ];
      ...
      <div className="container max-w-6xl">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-gray-500 max-w-xl leading-relaxed">
              จงตื่นขึ้นเถิด ซัมมอนเนอร์! ถึงเวลาอัดฉีดพลังงานเวทมนตร์ (RP) 
              เข้าสู่เส้นเลือดแห่งตำนาน ปลดปล่อยสกินระดับพระเจ้าที่จะทำให้ศัตรูต้องก้มกราบด้วยความหวาดกลัว 
              จงบดขยี้ Nexus และประกาศศักดาแห่งชัยชนะให้กึกก้องทั่ว Summoner's Rift 
              ตำนานบทใหม่ของเจ้านั้น... ข้าจะเป็นผู้จารึกมันเอง!
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* STEP 1: PLAYER ID (Pattern: No Server) */}
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-400 font-medium italic">
                  * กรุณากรอก Riot ID ให้ถูกต้อง (รวมถึง Tag ด้านหลัง)
                </p>
              </div>
            </section>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                {/* No Server Row for this pattern */}
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-500 font-medium font-mono uppercase">
                    แพ็กเกจ
                  </span>
