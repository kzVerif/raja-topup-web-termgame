...
export default function TftMobileTopup() {
  const [selectedPackage, setSelectedPackage] = useState<TftPackage>();
  const [riotId, setRiotId] = useState("");

  // แปลงข้อมูลจาก JSON
  const packages: TftPackage[] = [
    { id: 1, price: 130, amount: "575 TFT Coins" },
    { id: 2, price: 290, amount: "1,380 TFT Coins" },
    { id: 3, price: 560, amount: "2,800 TFT Coins" },
    { id: 4, price: 890, amount: "4,500 TFT Coins" },
    { id: 5, price: 1250, amount: "6,500 TFT Coins" },
    { id: 6, price: 2550, amount: "13,500 TFT Coins" },
  ];
      ...
      <div className="container max-w-6xl">
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          <div className="relative w-32 h-32 md:w-40 md:h-40 shrink-0 overflow-hidden rounded-[2rem] shadow-lg">
            <Image
              src="/topup/tftm.png" // ใช้ไฟล์ tft.webp
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-gray-500 max-w-xl leading-relaxed">
              กระดานหมากรุกแห่งโชคชะตา The Convergence กำลังเพรียกหา! จงรวบรวมเหล่าแชมเปี้ยนและจัดทัพให้สะเทือนเลือนลั่น! 
              ใช้ TFT Coins อัญเชิญ Little Legends คู่ใจและ Arena สุดอลังการ เพื่อข่มขวัญศัตรูตั้งแต่เริ่มเกม... 
              อย่าปล่อยให้ดวงชะตากำหนดชีวิต จง Roll หา 3 ดาวให้ครบ แล้วบดขยี้คู่แข่งให้เหลือแต่ซาก!
            </p>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <span className="px-4 py-1.5 bg-blue-50 text-blue-600 rounded-full text-xs font-bold flex items-center gap-1.5">
                <Gamepad2 size={14} /> เหรียญเข้าทันที
              </span>
            </div>
          </div>
        </div>
            ...
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                <input
                  ...
                  value={riotId}
                  onChange={(e) => setRiotId(e.target.value)} // รับตัวอักษรได้
            ...
            <div className="sticky top-24 bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span
                    className={`font-bold ${riotId ? "text-gray-900" : "text-red-400 font-mono"}`}
                  >
                    {riotId || "REQUIRED"}
                  </span>
                </div>
