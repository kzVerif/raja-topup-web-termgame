...
export default function GenshinTopup() {
  ...
  const packages: ffPackages[] = [
    { id: 1, price: 158.02, amount: "พรแห่งดวงจันทร์", isSpecial: true },
    { id: 2, price: 31, amount: "60 Genesis Crystals" },
    { id: 3, price: 158, amount: "330 Genesis Crystals" },
    { id: 4, price: 483, amount: "1,090 Genesis Crystals" },
    { id: 5, price: 968, amount: "2,240 Genesis Crystals" },
    { id: 6, price: 1584, amount: "3,880 Genesis Crystals" },
    { id: 7, price: 3256, amount: "8,080 Genesis Crystals" },
    { id: 8, price: 35, amount: "60 Chronal Nexus" },
    { id: 9, price: 179, amount: "330 Chronal Nexus" },
    { id: 10, price: 519, amount: "1,090 Chronal Nexus" },
    { id: 11, price: 1100, amount: "2,240 Chronal Nexus" },
    { id: 12, price: 1700, amount: "3,880 Chronal Nexus" },
    { id: 13, price: 3400, amount: "8,080 Chronal Nexus" },
  ];
        ...
        <div className="bg-white rounded-[2.5rem] p-8 mb-8 border border-gray-100 shadow-sm flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="space-y-3 text-center md:text-left">
            ...
            <p className="text-gray-500 max-w-xl leading-relaxed">
              เบื้องหน้าบัลลังก์แห่งเซเลสเทีย
              มีเพียงผู้ครอบครองอำนาจแห่งผลึกมหาศาลเท่านั้นที่จะสยบเทพเจ้า
              จงอัญเชิญเหล่าขุนพลระดับ 5 ดาวและศาสตราในตำนานมาสยบแทบเท้า
              เพื่อประกาศศักดาให้โลกแห่ง Teyvat
              ได้ประจักษ์ว่าใครคือมหาราชาที่แท้จริง
              ผ่านพันธสัญญาเติมพลังเร้นลับที่รวดเร็วและมั่นคงที่สุดในใต้หล้า
            </p>
            ...
            <section className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <User size={20} className="text-indigo-600" /> กรอก UID ผู้เล่น
                </h2>
              </div>
